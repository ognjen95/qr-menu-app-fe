...
const OrderBottomNav = ({ colorPallete }: { colorPallete: ColorPallete }) => {
  const { resetOrder, total } = useOrderContext();

  return (
    <div className="p-3 sticky right-10 left-10 bottom-0">
      <div className="flex items-center space-x-5 justify-between w-full sticky right-10 left-10 bottom-5 p-3 bg-white/50 backdrop-blur rounded-xl">
