...
import { UseCreateMenuItemReturn } from "./useCreateMenuItem";
...
const CreateMenuItemFormModal: FC<CreateMenuItemFeatureProps> = ({
  ...
  <Modal
    ...
    title={`Add new item to "${modal?.params?.sectionName ?? ""}" section`}
  ...
  >
    <Form
      ...
      fullWidth
      fullHeight
      onSubmit={createMenuSectionItem}
    >
      {({ control }) => (
        <div className="grid grid-cols-3 w-full gap-10 h-full">
          <div className="flex flex-col space-y-5 w-full py-5 col-span-1 items-center">
            ...
            <div
              ...
              className="hover:shadow-primary-300 cursor-pointer shadow w-fit rounded-xl overflow-hidden h-[200px] w-[200px] relative"
            >
              <Image
                alt="image"
          ...
          <div className="flex flex-col space-y-5 w-full py-5 col-span-1">
            ...
            <div className="flex flex-col w-full justify-between space-y-3">
              ...
              <div className="flex items-center flex-wrap gap-3">
                {["Milk", "Nutts", "Eggs", "Fish"].map((alergen) => (
                  <Chip
                    key={alergen}
                    text={alergen}
